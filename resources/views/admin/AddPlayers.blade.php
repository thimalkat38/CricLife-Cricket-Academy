...
<head>
    <meta charset="UTF-8">
    <title>CricLife Cricket Academy - Add Player</title>
    <!-- Favicon -->
        ...
        <div class="flex-1 flex flex-col min-h-screen bg-gray-50">
            ...
            <header class="w-full h-20 bg-white border-b border-gray-200 flex items-center px-8">
                <div class="w-full flex justify-between items-center">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xl font-semibold font-poppins text-gray-900">Add Player</span>
                    </div>
            ...
            <main class="flex-1 w-full px-8 py-8 overflow-y-auto">
                ...
                <div class="bg-white rounded-lg shadow-md p-8">
                    ...
                    <form method="POST" action="{{ route('admin.players.store') }}" enctype="multipart/form-data" class="space-y-6">
                        @csrf
                        ...
                        <div class="border-t pt-6 mt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="p_name" id="p_name" value="{{ old('p_name') }}"
                                ...
                                <div>
                                    ...
                                    <input type="text" name="p_num" id="p_num" value="{{ old('p_num') }}"
