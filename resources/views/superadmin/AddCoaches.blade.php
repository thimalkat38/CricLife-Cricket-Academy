...
<head>
    <meta charset="UTF-8">
    <title>CricLife Cricket Academy - Add Coach</title>
    <!-- Favicon -->
            ...
            <header class="w-full h-20 bg-white border-b border-gray-200 flex items-center px-8">
                <div class="w-full flex justify-between items-center">
                    <div class="flex items-center gap-2">
                        <span class="material-icons text-gray-400">person_add</span>
                        <span class="text-xl font-semibold font-poppins text-gray-900">Add Coach</span>
                    </div>
            ...
            <main class="flex-1 w-full px-8 py-8 overflow-y-auto">
                ...
                <div class="bg-white rounded-lg shadow-md p-8">
                    <h2 class="text-2xl font-semibold text-gray-800 mb-6 flex items-center">
                        <span class="material-icons mr-2 text-teal-500">person_add</span>
                        Coach Information
                    </h2>
                    ...
                    <form method="POST" action="{{ route('coaches.store') }}" enctype="multipart/form-data" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="role" id="role"
                                    ...
                                    <option value="Head Coach" {{ old('role') == 'Head Coach' ? 'selected' : '' }}>Head Coach</option>
                                    <option value="Assistant Coach" {{ old('role') == 'Assistant Coach' ? 'selected' : '' }}>Assistant Coach</option>
                                    <option value="Sub Assistant Coach" {{ old('role') == 'Sub Assistant Coach' ? 'selected' : '' }}>Sub Assistant Coach</option>
                                    <option value="Thrower" {{ old('role') == 'Thrower' ? 'selected' : '' }}>Thrower</option>
                                </select>
                                @error('role')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="text" name="num" id="num" value="{{ old('num') }}"
                        ...
                        <div>
                            ...
                            <textarea name="qualifications" id="qualifications" rows="3"
                                ...
                                placeholder="e.g., Level 2 Cricket Coaching Certificate, BSc Sports Science">{{ old('qualifications') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="address" id="address" rows="3"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('address') border-red-500 @enderror">{{ old('address') }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
