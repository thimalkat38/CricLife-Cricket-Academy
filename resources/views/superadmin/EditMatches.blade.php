...
<head>
    <meta charset="UTF-8">
    <title>CricLife Cricket Academy - Edit Match</title>
    <!-- Favicon -->
            ...
            <header class="w-full h-20 bg-white border-b border-gray-200 flex items-center px-8">
                <div class="w-full flex justify-between items-center">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xl font-semibold font-poppins text-gray-900">Edit Match</span>
                    </div>
                    ...
                    <form method="POST" action="{{ route('matches.update', $match) }}" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="team_1" id="team_1" value="{{ old('team_1', $match->team_1) }}"
                            ...
                            <div>
                                ...
                                <input type="text" name="team_2" id="team_2" value="{{ old('team_2', $match->team_2) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="date" name="date" id="date" value="{{ old('date', $match->date) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="type" id="type"
                                    ...
                                    <option value="One Day" {{ old('type', $match->type) == 'One Day' ? 'selected' : '' }}>One Day</option>
                                    <option value="2 Day" {{ old('type', $match->type) == '2 Day' ? 'selected' : '' }}>2 Day</option>
                                    <option value="3 Day" {{ old('type', $match->type) == '3 Day' ? 'selected' : '' }}>3 Day</option>
                                    <option value="T20" {{ old('type', $match->type) == 'T20' ? 'selected' : '' }}>T20</option>
                                    <option value="T10" {{ old('type', $match->type) == 'T10' ? 'selected' : '' }}>T10</option>
                                    <option value="Limited Overs One Day" {{ old('type', $match->type) == 'Limited Overs One Day' ? 'selected' : '' }}>Limited Overs One Day</option>
                                    <option value="Other" {{ old('type', $match->type) == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                                @error('type')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="level" id="level"
                                    ...
                                    <option value="U 09" {{ old('level', $match->level) == 'U 09' ? 'selected' : '' }}>U 09</option>
                                    <option value="U 11" {{ old('level', $match->level) == 'U 11' ? 'selected' : '' }}>U 11</option>
                                    <option value="U 13" {{ old('level', $match->level) == 'U 13' ? 'selected' : '' }}>U 13</option>
                                    <option value="U 15" {{ old('level', $match->level) == 'U 15' ? 'selected' : '' }}>U 15</option>
                                    <option value="U 17" {{ old('level', $match->level) == 'U 17' ? 'selected' : '' }}>U 17</option>
                                    <option value="U 19" {{ old('level', $match->level) == 'U 19' ? 'selected' : '' }}>U 19</option>
                                    <option value="Other" {{ old('level', $match->level) == 'Other' ? 'selected' : '' }}>Other</option>
                                </select>
                                @error('level')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                        ...
                        <div>
                            ...
                            <textarea name="note" id="note" rows="4"
                                ...
                                placeholder="Additional information about the match...">{{ old('note', $match->note) }}</textarea>
                            @error('note')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
