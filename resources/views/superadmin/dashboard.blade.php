...
<head>
    <meta charset="UTF-8">
    <title>CricLife Cricket Academy</title>
    <!-- Favicon -->
            ...
            <header class="w-full h-20 bg-white border-b border-gray-200 flex items-center px-8">
                <div class="w-full flex justify-between items-center">
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xl font-semibold font-poppins text-gray-900">Dashboard</span>
                        <span class="text-xl font-normal text-gray-700">superadmin</span>
                    </div>
