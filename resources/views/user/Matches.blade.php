                            ...
                            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 overflow-hidden border border-gray-200">
                                ...
                                <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
                                    <div class="flex justify-end">
                                        <a href="{{ route('user.matches.show', $match) }}"
                                            class="inline-flex items-center px-4 py-2 bg-teal-500 text-white text-sm font-medium rounded-lg hover:bg-teal-600 transition-colors duration-200">
                ...
                @else
                    <div class="bg-white rounded-lg shadow-md border border-gray-200">
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-500">There are no matches available at the moment.</p>
                        </div>
                    </div>
                @endif
            </main>
